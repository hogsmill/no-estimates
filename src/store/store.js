...
export const store = new Vuex.Store({
  state: {
    ...
    eventCards: [
      ...
      {number: 3, text: "Pizza inspires your team to greatness! Add one to each person's capacity tomorrow."},
      ...
      {number: 5, text: "You read that automating deployments can lead to better quality and more predictable delivery. If you'd like to invest in that, you'll need to spend 8 effort points in Deploy (you can do this over multiple sprints)"},
      {number: 6, text: "Would someone like to learn a new skill? If so, give this card to that person. After that person spends five days pairing with someone in a work stage different from his or her speciality, the person will be able to work in that state at a 1:1 effort ratio."},
      ...
      {number: 12, text: "Did you pair (more than one person worked on a single card in one work stage) today? If so, tick off an extra point of work in each stage where the pairing occured (for today only)"},
