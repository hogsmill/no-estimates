<template>
  <vue-final-modal name="chat-facilitator" classes="modal-container" content-class="vfm__content modal-content" v-model="modals['chatFacilitator']">
...
export default {
  ...
  methods: {
    hide() {
      this.$store.dispatch('hideModal', 'chatFacilitator')
    },
    scroll() {
